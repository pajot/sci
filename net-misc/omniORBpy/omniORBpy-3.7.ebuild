...
DESCRIPTION="The python back-end for omniORB, a robust high-performance CORBA ORB."
...
src_install() {
	...
	# resolve file collision with omniORB. This __init__.py is identical.
	rm -rf "${D}"/usr/lib64/python2.7/site-packages/omniidl_be/__init__.py
